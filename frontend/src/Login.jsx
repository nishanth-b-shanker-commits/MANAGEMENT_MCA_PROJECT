                ...
                <div className="login-right-card">
                    ...
                    {step === 4 && (
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <div style={{ background: 'white', padding: '1.5rem', display: 'inline-block', borderRadius: '4px', border: '1px solid var(--border)', boxShadow: 'var(--glass-shadow)', marginBottom: '1.5rem' }}>
