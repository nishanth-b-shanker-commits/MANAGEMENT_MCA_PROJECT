...
const TRANSLATIONS = {
  en: {
    ...
    logsAuditsSub: 'Consolidated, searchable view of port operations and security audits',
    refresh: 'Refresh',
    ...
    recentOpsLogsSub: 'Real-time clearance progress of active vessel journeys',
    ...
    searchVesselOrigin: 'Search vessel name or origin port...',
    allStatuses: 'All Statuses',
    export: 'Export',
    exportBtn: 'Export to CSV',
    systemAuditLogs: 'System Audit Logs',
    systemAuditLogsSub: 'Chronological history of security and configuration changes',
    ...
    searchActionUser: 'Search by action or username...',
    time: 'Time',
    timeLabel: 'Timestamp',
    userLabel: 'User',
    actionLabel: 'Action',
    clearancesLabel: 'Department Clearances',
    ...
    noMatchingAuditTrails: 'No matching system audit trails available.',
    vessel: 'Vessel',
    origin: 'Origin',
    // Login Translations
    login: 'Login',
    ...
    health: 'Health',
    adminRole: 'Admin',
    sketchpad: 'Marine Sketchpad',
    sketchpadSub: 'Interactive chart annotator, docking planner, and digital signature board',
    canvasBackground: 'Canvas Background',
    blankCanvas: 'Blank Canvas',
    blueprintGrid: 'Blueprint Grid',
    portMap: 'NMPA Berth Map',
    drawColor: 'Pen Color',
    ...
    toolRect: 'Rectangle',
    toolCircle: 'Circle',
    toolArrow: 'Directional Arrow',
    toolText: 'Text Label',
    clearCanvas: 'Clear All',
    downloadSketch: 'Export PNG',
    copySketch: 'Copy to Clipboard',
    attachToVoyage: 'Attach Voyage Plan',
  },
  hi: {
    // Nav & Common
    dashboard: 'डैशबोर्ड',
    ...
    logsAuditsSub: 'पोर्ट संचालन और सुरक्षा ऑडिट का एकीकृत, खोजने योग्य दृश्य',
    ...
    recentOpsLogsSub: 'सक्रिय पोत यात्राओं की वास्तविक समय स्वीकृति प्रगति',
    ...
    searchVesselOrigin: 'पोत का नाम या मूल बंदरगाह खोजें...',
    allStatuses: 'सभी स्थितियाँ',
    export: 'निर्यात करें',
    exportBtn: 'सीएसवी में निर्यात करें',
    systemAuditLogs: 'सिस्टम ऑडिट लॉग',
    systemAuditLogsSub: 'सुरक्षा और कॉन्फ़िगरेशन परिवर्तनों का कालानुक्रमिक इतिहास',
    ...
    searchActionUser: 'कार्रवाई या उपयोगकर्ता नाम द्वारा खोजें...',
    time: 'समय',
    timeLabel: 'समय-समय',
    userLabel: 'उपयोगकर्ता',
    actionLabel: 'कार्रवाई',
    clearancesLabel: 'विभागीय स्वीकृतियां',
    clearedStatus: 'स्वीकृत',
    pendingStatus: 'लंबित',
    ...
    noMatchingAuditTrails: 'कोई मिलान सिस्टम ऑडिट उपलब्ध नहीं है।',
    vessel: 'पोत',
    origin: 'मूल बंदरगाह',
    // Login Translations
    login: 'लॉगिन',
    ...
    health: 'हेल्थ',
    adminRole: 'एडमिन',
    sketchpad: 'समुद्री स्केचपैड',
    sketchpadSub: 'इंटरैक्टिव चार्ट एनोटेटर, डॉकिंग प्लानर और डिजिटल सिग्नेचर बोर्ड',
    canvasBackground: 'कैनवास पृष्ठभूमि',
    blankCanvas: 'खाली कैनवास',
    blueprintGrid: 'ब्लूप्रिंट ग्रिड',
    portMap: 'एनएमपीए बर्थ मानचित्र',
    drawColor: 'पेन का रंग',
    brushSize: 'ब्रश का आकार',
    brushOpacity: 'अपारदर्शिता',
    drawTool: 'ड्रॉइंग टूल',
    toolPen: 'फ्रीहैंड पेन',
    toolEraser: 'रबर (इरेज़र)',
    toolLine: 'सीधी रेखा',
    toolRect: 'आयत',
    toolCircle: 'वृत्त (गोला)',
    toolArrow: 'दिशात्मक तीर',
    toolText: 'टेक्स्ट लेबल',
    clearCanvas: 'सब साफ करें',
    downloadSketch: 'पीएनजी निर्यात करें',
    copySketch: 'क्लिपबोर्ड पर कॉपी करें',
    attachToVoyage: 'यात्रा योजना संलग्न करें',
  }
};
